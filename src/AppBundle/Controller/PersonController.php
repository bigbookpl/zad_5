...
class PersonController extends Controller
{
     ...
     * Lists all Person entities.
     *
     * @Route("/{person_id}/addAddress", name="add_address_person")
     * @Method("GET")
     * @Template("AppBundle:Address:new.html.twig")
     */
    public function addAddressAction($person_id)
    {
        $entity = new Address();

        $form   = $this->addAddressCreateForm($entity, $person_id);
     ...
     *
     * @Route("/{person_id}/addAddress", name="address_person_create")
     * @Method("POST")
     * @Template("AppBundle:Address:new.html.twig")
     */
    public function createAddressAction(Request $request, $person_id)
    {
        $address = new Address();
        $person = $this->getDoctrine()->getRepository('AppBundle:Person')->find($person_id);
        $address->setPerson($person);

        $form = $this->addAddressCreateForm($address, $person_id);
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('person_show', array('id' => $person_id)));
        }
    ...
    private function addAddressCreateForm(Address $entity, $personId)
    {
        $form = $this->createForm(new AddressType(), $entity, array(
            'action' => $this->generateUrl('address_person_create',array('person_id' => $personId)),
            'method' => 'POST',
        ));
